// Set the dates we're counting down to
  var countDownDates = {
    1: new Date("2024-06-01T13:00:00").getTime(),
    2: new Date("2024-06-01T14:00:00").getTime(),
    3: new Date("2024-06-01T15:00:00").getTime(),
    4: new Date("2024-06-01T16:00:00").getTime(),
    5: new Date("2024-06-01T17:00:00").getTime(),
    6: new Date("2024-06-01T08:00:00").getTime(),
  };
